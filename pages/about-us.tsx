  ...
  return (
    ...
    {/*<div className={styles.typewriter}>*/}
      <p className={'text-2xl'}>
        MINE.FM technology exists to make music discovery beneficial for both artists and fans connected through the communal appreciation of sound. Communities won’t form if kindred souls can’t connect. We let music function as the signal for that connection.
      </p>
      <p className={'text-2xl'}>

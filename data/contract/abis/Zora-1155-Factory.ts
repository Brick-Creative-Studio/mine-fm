const zoraContractFactoryABI = [

    {
      inputs: [
        ...
        { internalType: 'contract IMinter1155', name: '_merkleMinter', type: 'address' },
        {
    ...
    { inputs: [], name: 'Constructor_ImplCannotBeZero', type: 'error' },
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: true, internalType: 'address', name: 'baseImpl', type: 'address' },
        { indexed: true, internalType: 'address', name: 'upgradeImpl', type: 'address' },
      ],
    ...
    },
    {
      ...
      name: 'defaultMinters',
      outputs: [
        { internalType: 'contract IMinter1155[]', name: 'minters', type: 'address[]' },
      ],
    ...
    },
    {
      ...
      outputs: [{ internalType: 'contract IMinter1155', name: '', type: 'address' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
      inputs: [],
      name: 'implementation',
      outputs: [{ internalType: 'contract IZoraCreator1155', name: '', type: 'address' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
    ...
    {
      inputs: [
        { internalType: 'address', name: 'baseImpl', type: 'address' },
        { internalType: 'address', name: 'upgradeImpl', type: 'address' },
      ],
    ...
    {
      inputs: [
        { internalType: 'address[]', name: 'baseImpls', type: 'address[]' },
        { internalType: 'address', name: 'upgradeImpl', type: 'address' },
      ],
...
export default zoraContractFactoryABI

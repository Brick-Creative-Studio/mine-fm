const zora1155CreatorABI = [
    ...
    { inputs: [], name: 'CannotSetMintFeeToZeroAddress', type: 'error' },
    {
      inputs: [{ internalType: 'address', name: 'proposedAddress', type: 'address' }],
      name: 'Config_TransferHookNotSupported',
      type: 'error',
    },
    { inputs: [], name: 'ERC1155_ACCOUNTS_AND_IDS_LENGTH_MISMATCH', type: 'error' },
    { inputs: [], name: 'ERC1155_ADDRESS_ZERO_IS_NOT_A_VALID_OWNER', type: 'error' },
    { inputs: [], name: 'ERC1155_BURN_AMOUNT_EXCEEDS_BALANCE', type: 'error' },
    { inputs: [], name: 'ERC1155_BURN_FROM_ZERO_ADDRESS', type: 'error' },
    { inputs: [], name: 'ERC1155_CALLER_IS_NOT_TOKEN_OWNER_OR_APPROVED', type: 'error' },
    { inputs: [], name: 'ERC1155_ERC1155RECEIVER_REJECTED_TOKENS', type: 'error' },
    { inputs: [], name: 'ERC1155_IDS_AND_AMOUNTS_LENGTH_MISMATCH', type: 'error' },
    { inputs: [], name: 'ERC1155_INSUFFICIENT_BALANCE_FOR_TRANSFER', type: 'error' },
    ...
    { inputs: [], name: 'FUNCTION_MUST_BE_CALLED_THROUGH_ACTIVE_PROXY', type: 'error' },
    { inputs: [], name: 'FUNCTION_MUST_BE_CALLED_THROUGH_DELEGATECALL', type: 'error' },
    {
      inputs: [
        { internalType: 'uint256', name: 'amount', type: 'uint256' },
    ...
    {
      inputs: [{ internalType: 'uint256', name: 'mintFeeBPS', type: 'uint256' }],
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: false, internalType: 'address', name: 'lastOwner', type: 'address' },
    ...
    },
    {
      ...
      inputs: [
        { indexed: true, internalType: 'uint256', name: 'tokenId', type: 'uint256' },
        { indexed: true, internalType: 'address', name: 'user', type: 'address' },
        { indexed: true, internalType: 'uint256', name: 'permissions', type: 'uint256' },
      ],
    ...
    },
    {
      inputs: [
        { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
        { internalType: 'contract IMinter1155', name: 'salesConfig', type: 'address' },
        { internalType: 'bytes', name: 'data', type: 'bytes' },
      ],
      name: 'callSale',
      outputs: [],
    ...
    },
    {
      ...
      outputs: [{ internalType: 'contract IRenderer1155', name: '', type: 'address' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
    ...
    },
    {
      inputs: [
        { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
        { internalType: 'contract IRenderer1155', name: 'renderer', type: 'address' },
      ],
...
export default zora1155CreatorABI;
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: true, internalType: 'uint256', name: 'tokenId', type: 'uint256' },
        {
          ...
          indexed: false,
          internalType: 'struct BondingCurveSaleStrategy.SalesConfig',
          name: 'salesConfig',
          type: 'tuple',
        },
      ],
...
export default bondingCurveV2ABI

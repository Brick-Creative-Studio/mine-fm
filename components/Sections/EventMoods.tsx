...
export default function EventMoods({}) {
  return (
    <div className="flex flex-col m-8  md:w-full sm:w-full">
      <div className="flex w-2/3 md:w-full sm:w-full mb-8 rounded-lg h-32 border-solid border-white bg-[#535353]/50">
      ...
      <div className="flex w-2/3 md:w-96 sm:w-96 rounded-lg h-32 border-solid border-white bg-[#535353]/50">

...
export default function MoodForm({ }){
    ...
    const { register, handleSubmit, formState: { errors }, getValues } = useForm<MoodInputs>();
                        ...
                        <div className='flex flex-row justify-between'>
                            <div className='flex flex-col space-y-8 basis-1/2' >
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <input defaultValue="" className='bg-transparent h-10 border p-2 border-solid rounded-md text-white ' {...register("genres")} />
                                </div>

                                <div className='flex flex-col'>
                                    <label htmlFor="writers"> Writers </label>
                                    {/* register your input into the hook by invoking the "register" function */}
                                    <input defaultValue="" className='bg-transparent h-10 border p-2 border-solid rounded-md text-white ' {...register("tags")} />
                                </div>

                                <div className='flex flex-col'>
                                    <label htmlFor="featuredArtist"> Featured Artist </label>
                                    {/* register your input into the hook by invoking the "register" function */}
                                    <input defaultValue="" className='bg-transparent h-10 border p-2 border-solid rounded-md text-white ' {...register("description")} />
                                </div>
                                <div className='flex flex-col'>
                                    <label htmlFor="mixMaster"> Mix and Master </label>
                                    {/* register your input into the hook by invoking the "register" function */}
                                    <input defaultValue="" className='bg-transparent h-10 border p-2 border-solid rounded-md text-white ' {...register("tracklist")} />
                                </div>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    {/* register your input into the hook by invoking the "register" function */}
                                    <textarea defaultValue="feels like summer" className=' bg-transparent  h-44 border p-2 border-solid  rounded-md text-white ' {...register("posterUrl")} />
                                </div>

        ...
        isMobile ? (
          <div className={'flex w-fit h-12 border-solid border-[#654A8F] rounded-md overflow-x-hidden overflow-y-hidden relative cursor-pointer md:ml-12'}>
            <div className={'animate-marquee flex items-center justify-center pt-1 whitespace-nowrap'}>
              <div className={'rounded-full w-2 h-2 mx-2 bg-red-700 animate-pulse float-left'} />
          ...
          <div className={'flex items-center justify-center w-2/5 h-12 border-solid border-[#654A8F] rounded-md overflow-x-hidden overflow-y-hidden relative cursor-pointer md:ml-16'}>
            <div className={'flex items-center justify-center pt-1 whitespace-nowrap'}>
              <div className={'rounded-full w-2 h-2 mx-2 bg-red-700 animate-pulse float-left'} />
              <p className={'text-[#B999FA] text-center text-[16px]'}> MINE.FM Live Broadcasts </p>
            </div>
    ...
    <div className={NavBar}>
      ...
      {/*</div>*/}
      {
        isMobile ? (
          ...
          <div className={'flex items-center justify-center w-2/5 h-12 border-solid border-[#654A8F] rounded-md overflow-x-hidden overflow-y-hidden relative md:left-12 lg:left-28 cursor-pointer mx-auto'}>
            <div className={'flex items-center justify-center pt-1 whitespace-nowrap'}>
              <div className={'rounded-full w-2 h-2 mx-2 bg-red-700 animate-pulse float-left'} />
              <p className={'text-[#B999FA] text-center text-[16px]'}> MINE.FM Live Broadcasts </p>
            </div>
